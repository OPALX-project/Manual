...
approximation valid. In case of a cyclotron see Section link:elements#sec.elements.cyclotron[Cyclotron] the
...
* [[[bib.qiang2006-1,bib.qiang2006-1_fieldsolver]]] J. Qiang et al., _Three-dimensional quasi-static model for high brightness beam dynamics simulation_, Phys. Rev. ST Accel. Beams 9 (2006).
* [[[bib.qiang2006-2,bib.qiang2006-2_fieldsolver]]] J. Qiang et al., _Erratum: three-dimensional quasi-static model for high brightness beam dynamics simulation_, Phys. Rev. ST Accel. Beams 10, 12990 (2007).
