...
multigrid solvers `FMG` (till release 18.07) and `ML`. We also provide a hardware-architecture
independent solver which is described in <<sec.fieldsolvers.AMR.multigrid>>.
