...
& J.W. Eastwood <<bib_hockney>>. The PM solver introduces a discretization of
...
may be employed <<bib_hockney>>, <<bib_eastwoodandbrownrigg>> and <<bib_hockneyandeastwood>>. In
...
<<bib_qiangandryne>> , <<bib_qiangandgluckstern>>.
...
is identical to the Hockney method <<bib_hockney>>, <<bib_eastwoodandbrownrigg>>
and <<bib_hockneyandeastwood>>. Lastly, note that the above
...
integrated Green’s function is described in <<bib_qiang2005>>, <<bib_qiang2006-1>>,
<<bib_qiang2006-2>>. Default setting is `INTEGRATED`.
...
References
~~~~~~~~~~
* [[[bib_hockney]]] R. W. Hockney, _The potential calculation and some applications_, Methods Comput. Phys. 9, 136–210 (1970).
* [[[bib_eastwoodandbrownrigg]]] J. W. Eastwood and D. R. K. Brownrigg, _Remarks on the solution of poisson’s equation for isolated systems_, J. Comput. Phys. 32, 24–38 (1979).
* [[[bib_hockneyandeastwood]]] R. W. Hockney and J. W. Eastwood, _Computer simulation using particles_ (Taylor & Francis Group, 1988).
* [[[bib_qiangandryne]]] J. Qiang and R. Ryne, _Parallel 3d poisson solver for a charged beam in a conducting pipe_, Comput. Phys. Commun. 138, 18–28 (2001).
* [[[bib_qiangandgluckstern]]] J. Qiang and R. L. Gluckstern, _Three-dimensional poisson solver for a charged beam with large aspect ratio in a conducting pipe_, Comput. Phys. Commun. 160, 120–128 (2004).
* [[[bib_Adelmann2009p543]]] A. Adelmann, P. Arbenz, and Y. Ineichen, https://arxiv.org/abs/0907.4863[_A fast parallel poisson solver on irregular domains applied to beam dynamic simulations_], arXiv (2009).
