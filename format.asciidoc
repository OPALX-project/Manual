...
A `range` in a beam line (see Chapter link:lines#chp.lines[Beam Lines]) is
...
* When `place1` refers to a `LINE` (see Chapter link:lines#chp.lines[Beam Lines]),
the range starts at the *beginning* of this line.
* When `place2` refers to a `LINE` (see Chapter link:lines#chp.lines[Beam Lines]),
...
(see Chapter link:lines#chp.lines[Beam Lines]) the range contains the whole of the line.
