...
* {link_opal_pages}/Examples/Cyclotron.html[Cyclotron examples]
* {link_opal_pages}/Examples/RFPhotoInjector.html[RF photo injector examples]
* {link_opal_pages}/Examples/AWAEEXBeamline.html[AWA EEX beamline examples]
* {link_opal_pages}/Examples/AWADriveLinac.html[AWA drive linac examples]
* {link_opal_pages}/Examples/RegressionTestExamples.html[Regression-test examples]
* {link_opal_pages}/Examples/FFA.html[FFA examples]
* <<chp.tutorial,Tutorial>>

Users working at PSI can additionally consult
{link_opal_pages}/Using-OPAL-at-PSI[Using _OPAL_ at PSI].
...
page is {link_opal_pages}/For-Users/Distributions.html[Distributions].
opalx-end
...
* {link_opal_pages}/runOPAL.html[runOPAL] provides Python scripts to launch and
...
* {link_opal_pages}/OPAL-conversion-utilities.html[_OPAL_ conversion utilities]
...
<<bib.h5root_intro>> https://gitlab.psi.ch/OPAL/src/-/wikis/h5root[_H5root: a ROOT Based Graphical User Interface for H5hut_].
