...
.The simulation cycle
image::figures/tutorial/gen-str.png[width=6cm]
...
`AUTOPHASE` mode, as described in Section link:control#sec.control.option[Option Statement] and for example set
...
https://gitlab.psi.ch/OPAL/Manual-2.0/wikis/examples/opal-cycl.in[opal-cycl.in]
...
image::figures/cyclotron/injector2_orbit_and_tune.png[width=18cm]
...
Figure <<fig_eigen>> shows the eigen ellipse at symmetric line of sector
magnet for energy of 2 MeV in Injector II.

[#fig_eigen]
.Radial and vertical eigenellipse at 2 MeV of Injector II
image::figures/cyclotron/injector2_eigenellipse.png[width=18cm]
...
image::figures/cyclotron/Inj2-cyclParameters.png[width=18cm]

[#fig_cyclPhasespace]
.Vertical phase at different energy from left to right: 0.87 MeV, 15 MeV and 35 MeV
image::figures/cyclotron/Inj2-cyclPhasespace.png[width=18cm]
...
image::figures/cyclotron/ReferenceOrbit.png[width=18cm]

Figure <<fig_Ringref>> shows a single particle tracking
