...
.The simulation cycle
image::figures/tutorial/gen-str.png[pdfwidth=6cm]
...
image::figures/cyclotron/injector2_orbit_and_tune.png[pdfwidth=18cm]
...
image::figures/cyclotron/injector2_eigenellipse.png[pdfwidth=18cm]
...
image::figures/cyclotron/Inj2-cyclParameters.png[pdfwidth=18cm]

[#fig_cyclPhasespace]
.Vertical phase at different energy from left to right: 0.87 MeV, 15 MeV and 35 MeV
image::figures/cyclotron/Inj2-cyclPhasespace.png[pdfwidth=18cm]
...
image::figures/cyclotron/ReferenceOrbit.png[pdfwidth=18cm]
