...
`label` is an identifier (see link:format#sec.format.label[Identifiers or Labels]).
...
quantities occurring in real-expression (see link:format#sec.format.areal[Real Expressions]).
...
This statement creates a new global variable `variable-name` and
discards any old variable with the same name. Its value depends on all
quantities occurring in vector-expression (see link:format#sec.format.anarray[Arrays])
...
This statement creates a new global variable `variable-name` and
discards any old variable with the same name. Its value depends on all
quantities occurring in logical-expression (see link:format#sec.format.alogical[Logical Expressions]).
...
(see link:format#sec.format.anarray[Arrays]). Whenever an operand changes in
...
`message` is a string value (see link:format#sec.format.astring[String Attributes]).
...
The string (see link:format#sec.format.astring[String Attributes]) `string`
...
`page-header` is a string value (see link:format#sec.format.astring[String Attributes]).
...
`file-name` is a string (see link:format#sec.format.astring[String Attributes]).
...
For example one can set some link:control#sec.control.option[`OPTION`],
define a link:control#sec.control.macro[`MACRO`], or define some physics constants.
...
Therefore, it might be advisable to use an explicit link:control#sec.control.call[`CALL`] statement instead.
