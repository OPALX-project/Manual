...
| RANDOM    | Boolean to control whether sampling mode is random or sequential. 
...
| LATIN_HYPERCUBE   | In random mode only.
|=======================================================================
