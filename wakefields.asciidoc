...
be calculated numerically (see Sections <<sec.wakefield.wakefield_to_be_used>> - <<sec.wakefield.TAU>>).
...
see Section link:elements#sec.elements.common[Common Attributes for all Elements].

[[sec.wakefield.WTYPE]]
=== Define the wakefield type

A string value see Section link:format#sec.format.astring[String Attributes] to specify the wake function,
