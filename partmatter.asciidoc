...
image::figures/partmatter/dEdx.png[pdfwidth=12cm]
...
image::figures/partmatter/10steps.png[pdfwidth=12cm]
...
image::figures/partmatter/diagram.png[pdfwidth=16cm]

[#fig_CollPhysics2]
.The diagram of CollimatorPhysics in _OPAL_ (continued). 
image::figures/partmatter/Diagram2.png[pdfwidth=12cm]
...
https://gitlab.psi.ch/OPAL/Manual-2.0/wikis/examples/particlematterinteraction.in[particlematterinteraction.in]
...
image::figures/partmatter/longcoll6.png[pdfwidth=12cm]

[#fig_spectrum]
.The energy spectrum and scattering angle at z=0.1 m
image::figures/partmatter/spectandscatter.png[pdfwidth=12cm]
