...
the bending magnet. The results are reported in <<Emittance>> and in
<<fig_T3D_Tra_emi>>.
...
magnet features of <<Bend_Trace>> and <<Edge_Trace>> have been transformed
