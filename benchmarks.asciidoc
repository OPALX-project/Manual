...
image::figures/Benchmarks/Trace.png[scaledwidth=12cm]
...
image::figures/Benchmarks/TRANSPORT.png[scaledwidth=12cm]
...
image::figures/Benchmarks/Input_Trace.png[scaledwidth=8cm]
...
image::figures/Benchmarks/TRANS_SBEND_edge.png[scaledwidth=12cm]
...
image::figures/Benchmarks/T3D_Tra_SBEND_edge_env.png[scaledwidth=12cm]
...
image::figures/Benchmarks/T3D_Tra_SBEND_edge_emi.png[scaledwidth=12cm]
...
image::figures/Benchmarks/FI_SBEND_FMDef.png[scaledwidth=18cm,width=700]
+
...
image::figures/Benchmarks/FI_SBEND_FMTest.png[scaledwidth=18cm,width=700]
...
image::figures/Benchmarks/report-compare-default.png[scaledwidth=12cm]
...
image::figures/Benchmarks/report-emit-dt.png[scaledwidth=12cm]
...
image::figures/Benchmarks/report-fringe-size.png[scaledwidth=12cm]

.Zoom in on the final emittance in <<fig_plot-fringe-size>>
[[fig_plot-fringe-size-zoom,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/report-fringe-size-zoom.png[scaledwidth=12cm]
...
image::figures/Benchmarks/emit-csr-off.png[scaledwidth=12cm]
...
image::figures/Benchmarks/dpp-csr-on.png[scaledwidth=12cm]
...
image::figures/Benchmarks/emit-csr-on.png[scaledwidth=12cm]
...
image::figures/Benchmarks/opal-impact-1MHz.png[scaledwidth=18cm,width=700]

.Longitudinal beam size and emittance in `Impact-t` and __OPAL__
[[fig_plot-opal-impact2,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/opal-impact-1MHz-z.png[scaledwidth=10cm]

[[sec.benchmarks.bibliography]]
=== References

[[bib.TraceMan,*[{counter:bib-cnt}]*]] <<bib.TraceMan>> K. Crandall and D. Rusthoi, _Documentation for trace: an interactive beam-transport code_, tech. rep. (Los Alamos National Laboratory).

[[bib.transport,*[{counter:bib-cnt}]*]] <<bib.transport>> K. L. Brown et al., _TRANSPORT - A Computer Program for Designing Charged Particle Beam Transport Systems_, tech. rep. CERN 73-16, revised as CERN 80-4 (CERN, 1980).

[[bib.Transport_GUI,*[{counter:bib-cnt}]*]] <<bib.Transport_GUI>> U. Rohrer, _PSI graphic transport framework based on a cern-slac-fermilab version by K.L. Brown et al_, tech. rep. (PSI).

[[bib.Tran_ex,*[{counter:bib-cnt}]*]] <<bib.Tran_ex>> U. Rohrer, http://aea.web.psi.ch/Urs_Rohrer/MyWeb/moregifs/gantryb.gif.

[[bib.elegant,*[{counter:bib-cnt}]*]] <<bib.elegant>> M. Borland, https://www1.aps.anl.gov/icms_files/lsnotes/files/APS_1418218.pdf[_Elegant: a flexible SDDS-compliant code for accelerator simulation_], tech. rep. LS-287 (Advanced Photon Source, Sept. 2000).
