...
image::figures/Benchmarks/Trace.png[scalewidth=18cm]
...
image::figures/Benchmarks/TRANSPORT.png[scalewidth=18cm]
...
image::figures/Benchmarks/Trace_SBEND_edge.png[scalewidth=18cm]
...
image::figures/Benchmarks/TRANS_SBEND_edge.png[scalewidth=18cm]
...
image::figures/Benchmarks/T3D_Tra_SBEND_edge_env.png[scalewidth=18cm]
...
image::figures/Benchmarks/T3D_Tra_SBEND_edge_emi.png[scalewidth=18cm]
...
image::figures/Benchmarks/SBEND_noEdge_Env.png[scalewidth=8cm]
image::figures/Benchmarks/SBEND_noEdge_Emi.png[scalewidth=8cm]
+
...
image::figures/Benchmarks/SBEND_Edges_Env.png[scalewidth=8cm]
image::figures/Benchmarks/SBEND_Edges_Emi.png[scalewidth=8cm]
+
...
image::figures/Benchmarks/FI_SBEND_FMDef_Env_T2.png[scalewidth=8cm]
image::figures/Benchmarks/FI_SBEND_FMDef_Emi_T2.png[scalewidth=8cm]
+
...
image::figures/Benchmarks/FI_SBEND_FMTest_Env_T2.png[scalewidth=8cm]
image::figures/Benchmarks/FI_SBEND_FMTest_Emit_T2.png[scalewidth=8cm]
...
image::figures/Benchmarks/report-compare-default.png[scalewidth=18cm]
...
image::figures/Benchmarks/report-emit-dt.png[scalewidth=18cm]
...
image::figures/Benchmarks/report-fringe-size.png[scalewidth=18cm]

[#plot-fringe-size-zoom]
.Zoom in on the final emittance in <<plot-fringe-size>>
image::figures/Benchmarks/report-fringe-size-zoom.png[scalewidth=18cm]
...
image::figures/Benchmarks/emit-csr-off.png[scalewidth=18cm]
...
image::figures/Benchmarks/dpp-csr-on.png[scalewidth=18cm]
...
image::figures/Benchmarks/emit-csr-on.png[scalewidth=18cm]
...
image::figures/Benchmarks/opal-impact-1MHz-x.png[scalewidth=8cm]
image::figures/Benchmarks/opal-impact-1MHz-y.png[scalewidth=8cm]

[#plot-opal-impact2]
.Longitudinal beam size and emittance in `Impact-t` and __OPAL__
image::figures/Benchmarks/opal-impact-1MHz-z.png[scalewidth=18cm]
