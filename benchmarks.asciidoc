...
sigma-matrix structure is shown in <<trace_z>>.
...
to <<sec.T3D_input>>, the simulated input beam is described by the
...
line described in <<sec.T3D_TRAN>> has been simulated in _OPAL_ using
