...
The `DUMPEMFIELDS` statement causes _opal-cycl_ to write out electromagnetic field data on a 4D grid. Grids in a Cartesian coordinate system _(x,y,z,t)_ and a cylindrical coordinate system about the z-axis in _(r,\phi,z,t)_ are supported. 
