...
FMAPFN::
  ...
  see Section_<<sec.elements.elements.benddefaultfieldmapopalt>>. The field map is used to
...
Figures <<fig_rbend,1>> and <<fig.sbend,2>>. Bends in other directions within the x/y plane are
...
trajectory, as shown in Figures <<fig_rbend,1>> and <<fig.sbend,2>>.
...
element as illustrated in Figures <<fig_rbend,1>> and <<fig.sbend,2>>. (As already stated, any
...
=== General Multipole (will replace Section <<isec.elements.multipole>> when implemented)
