...
| probVariableWithID(<var>, <id>, <probe_file>)  | Returns the value of the variable (first argument) with a certain ID (second argument) from link:elements#sec.elements.probe-opal-cycl[probe] loss file (third argument).
|=======================================================================
