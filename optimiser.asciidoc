...
| A simple expression to get SDDS value near a specific position <refpos> of <refvar> for a variable <var>.
  The values of <refvar> should be monotonically increasing.
...
drmsx:   OBJECTIVE, EXPR="fabs(statVariableAt('rms_x', 's', ${loc}) - ${up})";
drmsy:   OBJECTIVE, EXPR="fabs(statVariableAt('rms_y', 's', ${loc}) - 0.0001833)";
goalfun: OBJECTIVE, EXPR="statVariableAt('rms_x', 's', 2.00)";
