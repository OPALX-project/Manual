...
Table <<fromfileinjfileformat,8>>. The particle coordinates are defined in Sections link:opalt#sec:variablesopalt[_OPAL-t_ variables] and link:opalcycl#sec:variablesopalcycl[_OPAL-cycl_ variables]. The _emitted_ file format is defined in
Table <<fromfileemitfileformat,9>>. The particle coordinates are defined in Section link:opalt#sec:variablesopalt[_OPAL-t_ variables] except that latexmath:[z], in meters, is replaced by latexmath:[t] in seconds.
[cols="<,<,<,<,<,<",]
