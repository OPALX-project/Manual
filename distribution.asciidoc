...
|`IMAGENAME` | |None |Used for h5 files. Name of the groups containing the laser image, see [regression test](https://gitlab.psi.ch/OPAL/regression-tests/blob/master/RegressionTests/LaserEmission-1/LaserEmission-1.in).
