...
\frac{df}{ds}&= \sum_{i=1}^{n} \left( \frac{\partial H}{\partial p_i}\frac{\partial f}{\partial q_i} -\frac{\partial H}{\partial q_i}\frac{\partial f}{\partial p_i} \right)  \equiv -\lieoperator{H} f
\end{align}
++++
...
\begin{align}
	...
	\mathcal{M} &= e^{-\lieoperator{H} s}
\end{align}
++++

Where latexmath:[e^{-\lieoperator{H} s}] is the Lie expansion. 
