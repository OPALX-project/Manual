...
++++
\begin{aligned}
     f = \mathbf{\mathcal{M}} = \underbrace{\sum_{n=0}^{\Omega} \frac{f^{\left(n\right)}}{n !} \left( \vec{v}_{\left( \Delta s\right)} \right)^n}_{\text{Taylor series}} + \underbrace{\mathcal{O}\left( \vec{v}_{\left( \Delta s\right)}^{\,\Omega +1}\right) }_{\text{error term}}
\end{aligned}
++++
