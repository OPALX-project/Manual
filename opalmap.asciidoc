...
_OPAL-map_ uses the following canonical variables to
...
X::
  ...
  of the element [m].
PX::
  latexmath:[\frac{p_x}{P_0}] Normalized horizontal canonical momentum [1].(Where latexmath:[p_x] is the momentum of the particle and latexmath:[P_0] is the momentum of the reference particle)
...
Z::
  ...
  co-ordinates [m].
DELTA::
  latexmath:[\frac{E}{P_0 c}-\frac{1}{\beta_0}] Energy derviation [1]. (Where latexmath:[E] is the total energy of the particle and latexmath:[\beta_0 = \frac{v}{c}] the speed relative to the speed of light latexmath:[c] of the reference particle)
