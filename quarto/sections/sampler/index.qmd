...
::: {.feature-opalx}
The sampler chapter below describes the legacy `OPAL` sampling workflow. It is
not currently mirrored as a corresponding `OPALX` user feature.
:::
...
![Difference between raster and non-raster sampling.](figures/differenceSEQUENCESampler.svg){#fig-sampler-raster-vs-sequence width="70%"}
