...
MB_BINNING::
  ...
  When `BUNCH_BINNING` binning, then all particles of a bunch are in the same energy bin.
  When `GAMMA_BINNING` binning, then the bin depends on the momentum of the particle.
