...
`TYPE` selects the actual solver backend. At present `FFT` based
solver is the most stable solver.

### Domain Decomposition

`PARFFTX`, `PARFFTY`, and `PARFFTZ` decide whether the corresponding mesh
...
`NX`, `NY`, and `NT` define the rectangular mesh resolution in `x`, `y`, and
