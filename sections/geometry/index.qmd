...
::: {.feature-opalx}
The command described here is the legacy `OPAL` geometry interface. It should
not be read as a statement that the same user-facing command set is currently
mirrored in `OPALX`.
:::
