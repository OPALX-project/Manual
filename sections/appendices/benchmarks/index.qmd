...
codes TRACE 3D and TRANSPORT [@crandallrusthoi1985; @brown1980transport].
...
The second benchmark family studies a hard-edge dipole against ELEGANT [@borland2000elegant].
...
`H+` bunch expanding in a `1 m` drift [@impacttmanual]. The setup uses:
