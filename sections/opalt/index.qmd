...
| 12-14 | `emit_x`, `emit_y`, `emit_s` | `m rad` | normalized emittance |
...
OPAL supports workflows with more than one species or beam component sharing
the same beamline. The exact setup depends on the beam and tracking commands.
