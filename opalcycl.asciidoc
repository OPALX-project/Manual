...
Section <<sec.opalcycl.variables>>.
...
coordinate system see Section <<sec.opalcycl.variables>>. At the beginning of the
...
see Section link:elements#sec.elements.cyclotron[Cyclotron]. Note that latexmath:[p_{\phi 0}] is
...
`TYPE` of `CYCLOTRON` see Section link:elements#sec.elements.cyclotron[Cyclotron] in the input file.
...
image::./figures/cyclotron/CarbonFieldFormat.png[width=6cm]
...
please see Section link:elements#sec.elements.cyclotron[Cyclotron].

[[sec.opalcycl.default-psi-format]]
==== Default PSI format
...
`CYCLOTRON`, please refer to Section link:elements#sec.elements.cyclotron[Cyclotron].
...
cavities, see Section link:elements#sec.elements.cyclotron[Cyclotron].
...
shapes. For the detail about its usage, please see Section link:elements#sec.elements.cyclotron[Cyclotron].
...
https://gitlab.psi.ch/OPAL/Manual-2.0/wikis/examples/tuning.sh[tuning.sh]
...
see Section link:control#sec.control.option[Option Statement].
...
the `SPTDUMPFREQ` option of `OPTION` statement see Section link:control#sec.control.option[Option Statement].
...
https://gitlab.psi.ch/OPAL/Manual-2.0/wikis/examples/matchedDistribution.in[matchedDistribution.in]

[[output-1]]
Output
++++++

https://gitlab.psi.ch/OPAL/Manual-2.0/wikis/examples/matchedDistribution.output[matchedDistribution.output]
