...
https://gitlab.psi.ch/OPAL/Manual-2.1/wikis/examples/tuning.sh[tuning.sh]
...
https://gitlab.psi.ch/OPAL/Manual-2.1/wikis/examples/matchedDistribution.in[matchedDistribution.in]

[[sec.opalcycl.output-1]]
===== Output

https://gitlab.psi.ch/OPAL/Manual-2.1/wikis/examples/matchedDistribution.output[matchedDistribution.output]
