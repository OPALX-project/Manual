...
See link:opalt#sec.opalt.input_file_name-.stat[_OPAL-t_ stat file]. The only 
difference is in the cyclotron coordinate convention. The z (or s) coordinate refers to the vertical 
direction and y corresponds to the longitudinal or beam travel direction. 
...
<<bib.schietinger>> T. Schietinger, https://gitlab.psi.ch/OPAL/src/wikis/h5root[_H5root_], 2006.
