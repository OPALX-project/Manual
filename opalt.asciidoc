...
an integrated Green <<bib.qiang2005_opalt>>, <<bib.qiang2006-1_opalt>>, <<bib.qiang2006-2_opalt>> function to
...
cathode <<bib.fubiani2006>>, <<bib.qiang2005_opalt>>, <<bib.qiang2006-1_opalt>>,<<bib.qiang2006-2_opalt>>. For
...
X::
  ...
  of the element [m].
PX::
  latexmath:[\beta_x\gamma] Horizontal canonical momentum [link:distribution#sec.distribution.unitsdistattributes[Units]].
Y::
  Horizontal position latexmath:[y] of a particle relative to the axis
  of the element [m].
PY::
  latexmath:[\beta_y\gamma] Horizontal canonical momentum [link:distribution#sec.distribution.unitsdistattributes[Units]].
Z::
  Longitudinal position latexmath:[z] of a particle in floor
  co-ordinates [m].
PZ::
  latexmath:[\beta_z\gamma] Longitudinal canonical momentum [link:distribution#sec.distribution.unitsdistattributes[Units]].
...
link:elements#sec.elements.common[Common Attributes for all Elements].
...
See link:elements#sec.elements.common[Common Attributes for all Elements]
...
image::figures/opalt/coords.png[scaledwidth=12cm]
...
and `ORIENTATION`, see link:lines#sec.lines.simple-beam-lines[Simple Beam Lines].
...
image::figures/opalt/curvcoords.png[scaledwidth=10cm]
...
auto-phases the rf-structure, see Appendix link:autophase#appendix.autophasing[Auto-phasing Algorithm]. The multi map
...
image::figures/opalt/flowdiagram.png[scaledwidth=12cm]
...
image::./figures/opalt/elementIndicator.png[scaledwidth=6cm]
...
see Chapter link:beam-command#chp.beam-command[Beam Command], however due to the underlying general structure, the
...
[[bib.qiang2005_opalt,*[{counter:bib-cnt}]*]] <<bib.qiang2005_opalt>> J. Qiang et al.,  http://repositories.cdlib.org/lbnl/LBNL-59098[_A three-dimensional quasi-static model for high brightness beam dynamics simulation_], tech. rep. LBNL-59098 (LBNL).

[[bib.qiang2006-1_opalt,*[{counter:bib-cnt}]*]] <<bib.qiang2006-1_opalt>> J. Qiang et al., _Three-dimensional quasi-static model for high brightness beam dynamics simulation_, Phys. Rev. ST Accel. Beams 9 (2006).

[[bib.qiang2006-2_opalt,*[{counter:bib-cnt}]*]] <<bib.qiang2006-2_opalt>> J. Qiang et al., _Erratum: three-dimensional quasi-static model for high brightness beam dynamics simulation_, Phys. Rev. ST Accel. Beams 10, 12990 (2007).

[[bib.fubiani2006,*[{counter:bib-cnt}]*]] <<bib.fubiani2006>> G. Fubaiani et al., _Space charge modeling of dense electron beams with large energy spreads_, Phys. Rev. ST Accel. Beams 9, 064402 (2006).

[[bib.langdon,*[{counter:bib-cnt}]*]] <<bib.langdon>> A. B. L. Ch. K. Birdsall, _Plasma physics via computer simulation_ (McGraw-Hill, New York, 1985).

[[bib.tait-bryan_opalt,*[{counter:bib-cnt}]*]] <<bib.tait-bryan_opalt>> https://en.wikipedia.org/wiki/Euler_angles#Tait.E2.80.93Bryan_angles[_Tait-bryan angles_].

[[bib.borland1995_opalt,*[{counter:bib-cnt}]*]] <<bib.borland1995_opalt>> M. Borland,  http://accelconf.web.cern.ch/AccelConf/p95/ARTICLES/WAE/WAE11.PDF[_A self-describing file protocol for simulation integration and shared postprocessors_], in Proc. PAC (1995), pp. 2184–2186.

[[bib.borland2016,*[{counter:bib-cnt}]*]] <<bib.borland2016>> M. Borland et al., http://www.aps.anl.gov/Accelerator_Systems_Division/Accelerator_Operations_Physics/manuals/SDDStoolkit/SDDStoolkit.pdf[_User’s guide for SDDS toolkit version 2.8_].

[[bib.paraview,*[{counter:bib-cnt}]*]] <<bib.paraview>> A. Henderson, _ParaView guide: a parallel visualization application_ (Kitware Inc, 2007).

[[bib.paraview2,*[{counter:bib-cnt}]*]] <<bib.paraview2>> http://www.paraview.org[_ParaView_].

[[bib.visit,*[{counter:bib-cnt}]*]] <<bib.visit>> https://wci.llnl.gov/simulation/computer-codes/visit/[VisIt].
