...
image::./figures/Fieldmaps/order.png[scaledwidth=18cm,width=375]
...
a negative coefficient for the highest degree in the original data.

.Effect of a negative coefficient for the highest degree in the original data.
[[fig_Enge_poly,Figure {counter:fig-cnt}]]
image::./figures/Fieldmaps/Enge_poly.png[scaledwidth=16cm,width=700]
...
image::./figures/Fieldmaps/profile-1.png[scaledwidth=16cm,width=700]
...
image::./figures/Fieldmaps/RBendType1.png[scaledwidth=12cm]
...
image::./figures/Fieldmaps/SBendType1.png[scaledwidth=12cm]
...
[[bib.enge_fieldmaps,*[{counter:bib-cnt}]*]] <<bib.enge_fieldmaps>> J. E. Spencer and H. A. Enge, _Split-pole magnetic spectrograph for precision nuclear spectroscopy_, Nucl. Instrum. Methods 49, 181–193 (1967).

[[bib.superfish,*[{counter:bib-cnt}]*]] <<bib.superfish>> J. H. Billen and L. M. Young, _Poisson superfish_, tech. rep. LA-UR-96-1834 (Los Alamos National Laboratory, 2004).
