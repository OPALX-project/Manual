...
image::./figures/Fieldmaps/order-1.png[scaledwidth=8cm]
image::./figures/Fieldmaps/order-2.png[scaledwidth=8cm]
...
image::./figures/Fieldmaps/1DDynamic_step82.png[scaledwidth=6cm]
image::./figures/Fieldmaps/1DDynamic_fast_step82.png[scaledwidth=6cm]
image::./figures/Fieldmaps/2DDynamic_step82.png[scaledwidth=6cm]
...
<<AstraMagnetoStatic>>. The first line forms the file header and
...
<<AstraDynamic>>. The first line forms the file header and tells
...
image::./figures/Fieldmaps/profile-1.png[scaledwidth=18cm]
