...
1DProfile1::
  ...
  see link:elements#sec.elements.RBend[RBend (_OPAL-t_)] and link:elements#sec.elements.SBend[SBend (_OPAL-t_)]. See <<sec.fieldmaps.1DProfile1>>.
2DElectroStatic::
...
`SBEND` elements sees link:elements#sec.elements.RBend[RBend (_OPAL-t_)], link:elements#sec.elements.SBend[SBend (_OPAL-t_)] and link:elements#sec.elements.opaltrbendsbendfields[Bend Fields from 1D Field Maps (_OPAL-t_)].
